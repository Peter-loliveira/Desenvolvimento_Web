...
var areaDanceteria = document.createElement("div")
// var lbDanceteria = document.createElement("label")
// lbDanceteria.innerHTML = "Ligar Danceteria"
// lbDanceteria.setAttribute("class", "lbDanceteria")
var lbVoltasDanceteria = document.createElement("label")
lbVoltasDanceteria.innerHTML = "Quantas voltas?"
lbVoltasDanceteria.setAttribute("class", "lbDanceteria")


var inpVoltasDanceteria = document.createElement("input")
inpVoltasDanceteria.setAttribute("type", "number")
inpVoltasDanceteria.setAttribute("min", "10")
inpVoltasDanceteria.setAttribute("mam", "500")
inpVoltasDanceteria.value = "10"
inpVoltasDanceteria.style.width = "70px"

var btDanceteria = document.createElement("button")
btDanceteria.innerHTML = "LIGAR"
btDanceteria.onclick = function () {
    ligarDanceteria(inpVoltasDanceteria.value)
}
areaDanceteria.appendChild(inpVoltasDanceteria)
areaDanceteria.appendChild(btDanceteria)

areaPostits.appendChild(areaDanceteria)
...
function morreDiabo() {
    let totalPostits = document.getElementsByClassName("postit")
...
function ligarDanceteria(voltas) {
